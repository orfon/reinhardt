...
exports.capfirst = function(value) {
   ...
   const out = value && (value.charAt(0).toUpperCase() + value.substring(1));
   return out;
}
exports.capfirst.isSafe = true;
...
const ljust = exports.ljust = function(value, arg){
   value = value + "";
   arg = parseInt(arg, 10);
...
exports.truncatewords = function(value, arg){
   ...
   for (let i = 0, j = value.length, count = 0, current, last; i < value.length; i++){
      current = value.charAt(i);
