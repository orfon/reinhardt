...
const FilterExpression = exports.FilterExpression = function(token, parser) {
    ...
    const stringIfUndefined = (parser && parser.environment !== undefined) ?
            parser.environment.stringIfUndefined :
            constants.TEMPLATE_STRING_IF_INVALID;
    Object.defineProperties(this, {
        filters: {value: filters, enumerable: true},
        varObj: {value: varObj, enumerable: true},
        stringIfInvalid: {value: stringIfUndefined, enumerable: true}
    });
    return this;
};
