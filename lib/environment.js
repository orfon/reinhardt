...
const TemplateEnvironment = exports.Environment = function(options) {
    ...
    const templateStringIfInvalid = (options.stringIfUndefined !== undefined) ?
    ...
    Object.defineProperties(this, {
        ...
        TEMPLATE_STRING_IF_INVALID: {value: templateStringIfInvalid},
 ...
 */
TemplateEnvironment.prototype.getTemplate = function(templateName) {
    const [source, origin] = this.loader.loadTemplateSource(templateName, this);
    if (source) {
