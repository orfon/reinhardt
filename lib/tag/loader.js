...
var IncludeNode = Node.augment(function() {
   this.constructor = function(templatePath, extraContext, isolatedContext) {
 ...
 *
 */
var BlockNode = Node.augment(function() {
   this.constructor = function (name, nodeList, parent) {
      this.name = name;
 ...
 *
 */
var ExtendsNode = Node.augment(function() {
   this.constructor = function(nodeList, parentName) {
      this.nodeList = nodeList;
