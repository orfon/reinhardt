...
var AutoEscapeControlNode = Node.augment(function() {
   this.constructor = function(setting, nodeList) {
...
var FilterNode = Node.augment(function() {
   this.constructor = function(filterExpr, nodeList) {
...
var FirstOfNode = Node.augment(function() {
   this.constructor = function(vars) {
      this.vars = vars;
      return this;
   }
   this.render = function(context) {
...
var SpacelessNode = Node.augment(function() {
...
var VerbatimNode = Node.augment(function() {
...
var WithNode = Node.augment(function() {
   this.constructor = function(nodeList, extraContext) {
      this.nodeList = nodeList;
...
var LoadNode = Node.augment(function() {
   this.constructor = function() {
      return this;
   },
   this.render = function(context) {
...
var WidthRatioNode = Node.augment(function() {
   this.constructor = function(valueExpression, maxExpression, maxWidth) {
