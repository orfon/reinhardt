 ...
 * IfEqualNode
 */
var IfEqualNode = Node.augment(function() {
   this.constructor = function(var1, var2, nodeListTrue, nodeListFalse, negate) {
      this.var1 = var1;
      this.var2 = var2;
...
var IfNode = Node.augment(function() {
   this.constructor = function(conditionsNodeLists) {
...
var TemplateLiteral = Literal.augment(function(base) {
   this.constructor = function(value, text) {
     base.constructor.apply(this, [value]);
 ...
 * TemplateIfParser
 */
var TemplateIfParser = IfParser.augment(function(base) {
   this.constructor = function(parser, tokens) {
     this.templateParser = parser;
     base.constructor.apply(this, [tokens]);
     return this;
   },
   this.createVar = function(value) {
