 ...
 * ForNode
 */
var ForNode = Node.augment(function() {
   this.constructor = function(loopVars, sequence, isReversed, nodeListLoop, nodeListEmpty) {
...
var CycleNode = Node.augment(function() {
   this.constructor = function(cyclevars, variableName, silent) {
...
var IfChangedNode = Node.augment(function() {
   this.constructor = function(nodeListTrue, nodeListFalse, varList) {
