...
PrefixOperator.prototype.led = function(left, parser) {
   throw new Error('Not expecting "' + this.id + '" as infix operator in iftag');
}
...
EndToken.prototype.nud = function(parser) {
   throw new Error('Unexpected end of expression in if tag');
}
 ...
 * IfParser
 */
var IfParser = exports.IfParser = function(tokens) {
