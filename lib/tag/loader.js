...
const INCLUDE_CACHE_KEY = '__includeCache'
...
IncludeNode.prototype.render = function(context) {
    ...
    if (typeof(template.render) !== 'function') {
        // cache included templates in toplevel renderContext
...
ExtendsNode.prototype.render = function(context) {
    ...
    let compiledParent = (typeof(this.parentName) !== 'string') ?
            this.parentName.resolve(context) :
            this.parentName;
    // does this quack like a Template?
    if (typeof(compiledParent.render) !== 'function') {
        compiledParent = this.env.getTemplate(compiledParent);
    }
...
exports.include = function(parser, token) {
    ...
    const path = getRelativePath(parser.origin.templateName, bits[1]);
...
exports.extends = function(parser, token) {
    ...
    const parent = getRelativePath(parser.origin.templateName, bits[1]);
